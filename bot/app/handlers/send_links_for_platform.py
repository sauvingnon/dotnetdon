...
async def send_links_for_platform(callback: CallbackQuery, state: FSMContext):
    ...
    if platform == "platform_ios":
        ...
        await callback.message.answer('Скачивай это приложение по' + ' [ссылке](https://play.google.com/store/apps/details?id=app.hiddify.com)', parse_mode='Markdown', reply_markup=download_check_keyboard)
    else:
